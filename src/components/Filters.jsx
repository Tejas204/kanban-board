...
const Filters = () => {
  ...
  return (
    <div className='flex flex-col gap-y-9 w-[25%] bg-[color:var(--filter-bg--color)] px-14 py-5'>
      {/* Title */}
      ...
      <div className='flex flex-col'>
        <form className='flex flex-col gap-y-6'>
          {/* State */}
          <select name='state' id='state' className='p-3 text-lg rounded-md bg-[color:var(--filter-bg--color)] border-[0.1rem] text-[color:var(--primary-text--color)]'>
          ...
          {/* Assigned to */}
          <select name='assignment' id='assignment' className='p-3 text-lg rounded-md bg-[color:var(--filter-bg--color)] border-[0.1rem] text-[color:var(--primary-text--color)]'>
