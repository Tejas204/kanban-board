  ...
  return (
    <div className="flex flex-col gap-y-9 w-[25%] bg-[color:var(--filter-bg--color)] px-14 py-5">
      ...
      <div className="flex flex-row gap-10 items-center">
        <p className="text-2xl text-[color:var(--primary-text--color)]">
          Filter tasks
        </p>
      </div>
      ...
      <div className="flex flex-col">
        <form className="flex flex-col gap-y-6">
          ...
          <select
            name="state"
            id="state"
            className="p-3 text-lg rounded-md bg-[color:var(--filter-bg--color)] border-[0.1rem] text-[color:var(--primary-text--color)]"
          >
