    ...
    <div className='grid grid-cols-3 gap-x-2 w-[100%] mt-[5%] py-14 px-10 bg-[color:var(--header-bg--color)]'>
        ...
        <div className='flex flex-col gap-y-6 px-6 border-l-[0.1rem] border-[color:var(--secondary-text--color)]'>
            ...
            <form className='flex flex-col gap-y-8'>
                ...
                <button className='p-4 bg-[color:var(--button-bg--color)] text-[color:var(--button-text--color)] text-lg font-bold rounded-md hover:ring-2 ring-[color:var(--button-bg--color)] ring-offset-4 ring-offset-[color:var(--card-bg--color)] transition delay-150 ease-in-out'>Submit</button>
            </form>
        </div>
    </div>
  )
