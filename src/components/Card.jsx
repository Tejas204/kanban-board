...
const Card = ({id, title, short_description, assigned_to, priority, state_id}) => {
  ...
  const hamburgerIcon = <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  ...
  return (
    // Parent div
    <div className={`flex flex-col w-[100%] rounded-sm border-l-8 bg-[color:var(--card-bg--color)] 
