            ...
            <form className="flex flex-col justify-center gap-y-10">
              <div className="flex flex-col py-7 items-start justify-start">
                <p className="text-[color:var(--board-bg--color)] font-medium text-xl">
                  If you delete this state, then all cards belonging to this
                  state will also be deleted. Do you want to proceed?
                </p>
              </div>
              ...
              <div className="flex flex-row justify-start gap-x-10">
                ...
                <button
                  type="submit"
                  className={`p-4 w-1/4 bg-[color:var(--card-priority--color-high)] text-[color:var(--button-text--color)] text-lg font-bold rounded-md hover:ring-4 
